...
import 'package:basic_banking_app/Views/Screens/payment_screen.dart';
import 'package:basic_banking_app/Views/Widgets/customer_list.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Padding(
              padding: EdgeInsets.symmetric(vertical: mgDefaultPadding),
              child: Container(
